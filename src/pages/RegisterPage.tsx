...
export const RegisterPage: React.FC = () => {
  ...
  /**
   * Registration mutation using useAsyncMutation hook
   */
  const { mutate: performRegister, loading: isLoading, error: registerError } = useAsyncMutation(
    async () => {
      // Validation checks
    ...
    },
    {
      ...
      successMessage: 'Hesap başarıyla oluşturuldu! Giriş sayfasına yönlendiriliyorsunuz...',
      autoLog: true,
      onSuccess: () => {
        navigate('/login');
      },
