...
export const convertSupabaseUser = (supabaseUser: any): User => {
  return {
    ...
    kycLevel: supabaseUser.kyc_level || 'level_1',

    // Investor Tier
    investorTier: supabaseUser.investor_tier,
    minimumInvestment: supabaseUser.minimum_investment,
    monthlyLimit: supabaseUser.monthly_limit,
    tradingFeeRate: supabaseUser.trading_fee_rate,
    stakingMultiplier: supabaseUser.staking_multiplier,
    tierUpgradedAt: supabaseUser.tier_upgraded_at,
    tierBenefits: supabaseUser.tier_benefits,

    // Contact & Location
    walletAddress: supabaseUser.wallet_address,
    phone: supabaseUser.phone,
    country: supabaseUser.country,
    language: supabaseUser.language || 'tr',
